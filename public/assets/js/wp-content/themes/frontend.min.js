  ...
  (astScrollToTopHandler = function (e, t) {
    ...
    "both" == n || ("desktop" == n && "769" == a) || ("mobile" == n && "" == a)
      ? ((n = window.pageYOffset || document.body.scrollTop),
        e && e.length ? (n > e.offsetHeight + 100 ? (t.style.display = "block") : (t.style.display = "none")) : 300 < window.pageYOffset ? (t.style.display = "block") : (t.style.display = "none"))
  ...
  (function () {
      ...
      if ("off-canvas" === e) {
        ...
        for (let e = 0, t = popupLinks.length; e < t; e++)
          null !== popupLinks[e].getAttribute("href") &&
            (popupLinks[e].getAttribute("href").startsWith("#") || -1 !== popupLinks[e].getAttribute("href").search("#")) &&
            (!popupLinks[e].parentElement.classList.contains("menu-item-has-children") ||
              (popupLinks[e].parentElement.classList.contains("menu-item-has-children") && document.querySelector("header.site-header").classList.contains("ast-builder-menu-toggle-icon"))) &&
          ...
          for (let e = 0; e < l.length; e++) {
            ...
            for (link = 0, len = r.length; link < len; link++)
              null !== r[link].getAttribute("href") &&
                (r[link].getAttribute("href").startsWith("#") || -1 !== r[link].getAttribute("href").search("#")) &&
                (!r[link].parentElement.classList.contains("menu-item-has-children") ||
                  (r[link].parentElement.classList.contains("menu-item-has-children") && document.querySelector("header.site-header").classList.contains("ast-builder-menu-toggle-icon"))) &&
                (r[link].addEventListener("click", p, !0), (r[link].headerType = "dropdown"));
          }
        if (s) {
    ...
    "" !== (m = null != c ? c.querySelector("#ast-mobile-header") : m) && null !== m && (d = m.dataset.type),
      ...
      (popupTriggerClick = function (e) {
        ...
        u.classList.contains("ast-popup-nav-open") || u.classList.add("ast-popup-nav-open"),
          ...
          "desktop" === e && ((t.querySelector(".ast-mobile-popup-content").style.display = "none"), (t.querySelector(".ast-desktop-popup-content").style.display = "block")),
          "mobile" === e && ((t.querySelector(".ast-desktop-popup-content").style.display = "none"), (t.querySelector(".ast-mobile-popup-content").style.display = "block")),
    ...
    window.addEventListener("resize", function () {
      ...
      "INPUT" !== document.activeElement.tagName &&
        ...
        (null !== navigator.userAgent.match(/Android/i) && "Android" === navigator.userAgent.match(/Android/i)[0] ? window.visualViewport.width : window.innerWidth) !== s &&
          (t && null === n && t.click(), document.body.classList.remove("ast-main-header-nav-open", "ast-popup-nav-open"), e) &&
          null == n &&
          e.click(),
        h(),
        AstraToggleSetup());
    ...
    for (
      var t,
        ...
        h = function () {
          ...
          if (((u.style.overflow = e), astra.break_point < t || 0 === t)) {
            if (0 < l.length) for (var a = 0; a < l.length; a++) null !== l[a] && l[a].classList.remove("toggled");
        ...
        f =
          ...
          (AstraToggleSubMenu = function (e) {
              ...
              var t = this.parentNode,
                a =
                  (t.classList.contains("ast-submenu-expanded") &&
                    ...
                    (this.classList.contains("ast-menu-toggle") || ("" !== (e = t.querySelector("a").getAttribute("href")) && "#" !== e && (window.location = e))),
            ...
            t.classList.contains("menu-item-has-children") &&
              (astraToggleClass(t, "ast-submenu-expanded"), t.classList.contains("ast-submenu-expanded") ? (t.querySelector(".sub-menu").style.display = "block") : (t.querySelector(".sub-menu").style.display = "none"));
          }),
                ...
                0 <
                  (e =
                    "off-canvas" === d || "full-width" === d
                      ? ((t = document.querySelectorAll("#ast-mobile-popup, #ast-mobile-header")), (a = document.querySelectorAll("#ast-mobile-header .main-header-menu-toggle")).length)
                      : ((t = document.querySelectorAll("#ast-mobile-header")), (n = !(0 < (e = (a = document.querySelectorAll("#ast-mobile-header .main-header-menu-toggle")).length))) ? 1 : e)) ||
                n
              )
                for (var s = 0; s < e; s++)
                  if ((n || (a[s].setAttribute("data-index", s), i[s]) || ((i[s] = a[s]), a[s].addEventListener("click", astraNavMenuToggle, !1)), void 0 !== t[s]))
                    for (var o, l = 0; l < t.length; l++)
                      if (
                        0 <
                        (o = document.querySelector("header.site-header").classList.contains("ast-builder-menu-toggle-link")
                          ? t[l].querySelectorAll("ul.main-header-menu .menu-item-has-children > .menu-link, ul.main-header-menu .ast-menu-toggle")
                          : t[l].querySelectorAll("ul.main-header-menu .ast-menu-toggle")).length
                      )
            ...
            if ("undefined" != typeof astraAddon) astraNavMenuTogglePro(e, u, d, this);
              ...
              if (
                (null !== this.closest("#ast-fixed-header") &&
                  ((e = document.querySelectorAll("#ast-fixed-header > #ast-mobile-header .main-header-bar-navigation")), (l = document.querySelectorAll("#ast-fixed-header .main-header-menu-toggle")), (t = "0")),
                void 0 === e[t])
              )
                return !1;
              ...
              -1 !== (this.getAttribute("class") || "").indexOf("main-header-menu-toggle") &&
                ...
                e[t].classList.contains("toggle-on") ? ((e[t].style.display = "block"), u.classList.add("ast-main-header-nav-open")) : ((e[t].style.display = ""), u.classList.remove("ast-main-header-nav-open")));
            }
          }),
          u.addEventListener(
          ...
          (a = k.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || []),
          /trident/i.test(a[1])
            ? (t = /\brv[ :]+(\d+)/g.exec(k) || [])
            : ("Chrome" === a[1] && null != (t = k.match(/\bOPR|Edge\/(\d+)/))) ||
      ...
      f[y].onclick = function (e) {
        ...
        this.classList.contains("slide-search") &&
          (e.preventDefault(),
          (t = this.parentNode.parentNode.parentNode.querySelector(".ast-search-menu-icon")).classList.contains("ast-dropdown-active")
            ? ("" !== (t.querySelector(".search-field").value || "") && t.querySelector(".search-form").submit(), t.classList.remove("ast-dropdown-active"))
    ...
    function b() {
      ...
      if (e && !e.classList.contains("astra-search-icon") && null === e.closest(".ast-builder-menu") && -1 !== new String(e).indexOf("#")) {
        ...
        if (u.classList.contains("ast-header-break-point"))
          (document.querySelector("header.site-header").classList.contains("ast-builder-menu-toggle-link") && t.classList.contains("menu-item-has-children")) ||
        ...
        else for (; -1 === e.className.indexOf("nav-menu"); ) "li" === e.tagName.toLowerCase() && -1 !== e.className.indexOf("focus") && (e.className = e.className.replace(" focus", "")), (e = e.parentElement);
      }
    }
    function L() {
    ...
    if (
      ...
      if (k) for (const link of k) "" !== link.hash && link.addEventListener("click", S);
      function S(e) {
        let t = 0;
