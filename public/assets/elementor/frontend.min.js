  ...
  [819],
  {
              ...
              n.forEach((n) =>
                (function (e, n) {
                  ...
                  elementorFrontend.hooks.addAction(`frontend/element_ready/${s}`, (e) => {
                    if (isClassHandler(n)) t.addHandler(n, { $element: e, elementName: s }, !0);
                    else {
                      const i = n();
                      if (!i) return;
        ...
        constructor() {
          super(...arguments),
            ...
            (this.config.legacyMode = {
              get elementWrappers() {
                return (
                  elementorFrontend.isEditMode() && window.top.elementorDevTools.deprecation.deprecated("elementorFrontend.config.legacyMode.elementWrappers", "3.1.0", "elementorFrontend.config.experimentalFeatures.e_dom_optimization"),
      ...
      class BackgroundVideo extends elementorModules.frontend.handlers.Base {
        ...
        prepareVimeoVideo(e, t) {
          const n = this.getElementSettings(),
            i = { url: t, width: this.elements.$backgroundVideoContainer.outerWidth().width, autoplay: !0, loop: !n.background_play_once, transparent: !1, background: !0, muted: !0 };
        ...
        prepareYTVideo(e, t) {
          ...
          i.background_privacy_mode && ((o.host = "https://www.youtube-nocookie.com"), (o.origin = window.location.hostname)),
    ...
    3346: (e, t, n) => {
      ...
      e.exports = elementorModules.ViewModule.extend({
        getDefaultSettings: () => ({ scrollDuration: 500, selectors: { links: 'a[href*="#"]', targets: ".elementor-element, .elementor-menu-anchor", scrollable: (0, i.isScrollSnapActive)() ? "body" : "html, body" } }),
        getDefaultElements() {
          ...
          if (location.hostname === n.hostname && s && !(n.hash.length < 2)) {
            ...
            if (t.length) {
              ...
              r.length > 0 && (o -= r.height()),
                ...
                (0, i.isScrollSnapActive)() && elementorFrontend.elements.$body.css("scroll-snap-type", "none"),
    ...
    9469: (e) => {
      ...
      e.exports = function () {
        ...
        function _removeHook(e, t, i, s) {
          ...
          if (n[e][t])
            if (i)
              if (((o = n[e][t]), s)) for (a = o.length; a--; ) (r = o[a]).callback === i && r.context === s && o.splice(a, 1);
        ...
        function _runHook(e, t, i) {
          ...
          if (((o = r.length), "filters" === e)) for (s = 0; s < o; s++) i[0] = r[s].callback.apply(r[s].context, i);
    ...
    3308: (e, t) => {
      ...
      var c = { appleWebkit: matchUserAgent("AppleWebKit") && !d, blink: d, chrome: l, edge: a, firefox: s, ie: r, mac: matchUserAgent("Macintosh"), opera: i, safari: o, webkit: matchUserAgent("AppleWebKit") };
      t.default = c;
    },
    5107: (e, t) => {
      "use strict";
