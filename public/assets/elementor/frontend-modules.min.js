  ...
  [354],
  {
    ...
    806: (e, t, r) => {
      ...
      class BaseNestedTabs extends i.default {
        ...
        getDefaultSettings() {
          return {
            selectors: { tablist: '[role="tablist"]', tabTitle: ".e-n-tab-title", tabContent: ".e-con" },
        ...
        activateDefaultTab() {
          ...
          this.setSettings({ showTabFn: "show", hideTabFn: "hide" }), this.changeActiveTab(t), this.setSettings(r);
        }
        ...
        deactivateActiveTab(e) {
          ...
          o.add(s).removeClass(r), o.attr({ tabindex: "-1", "aria-selected": "false", "aria-expanded": "false" }), s[t.hideTabFn](), s.attr("hidden", "hidden");
        }
        activateTab(e) {
          const t = this.getSettings(),
            r = t.classes.active,
        ...
        changeActiveTab(e) {
          if (arguments.length > 1 && void 0 !== arguments[1] && arguments[1] && this.isEdit) return window.top.$e.run("document/repeater/select", { container: elementor.getContainer(this.$element.attr("data-id")), index: parseInt(e) });
    ...
    6412: (e, t, r) => {
      ...
      var n = r(3203),
        ...
        c = n(r(2821)),
        l = n(r(806));
      i.default.frontend = { Document: o.default, tools: { StretchElement: s.default }, handlers: { Base: a.default, SwiperBase: c.default, BaseNestedTabs: l.default } };
    },
    5658: (e) => {
      "use strict";
      e.exports = elementorModules.ViewModule.extend({
        getDefaultSettings: () => ({ element: null, direction: elementorFrontend.config.is_rtl ? "right" : "left", selectors: { container: window } }),
        getDefaultElements() {
    ...
    2618: (e, t, r) => {
      "use strict";
      var n = r(3203);
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = void 0), r(740);
      var i = n(r(7597)),
        o = n(r(381));
    ...
    869: (e, t, r) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = t.ForceMethodImplementation = void 0), r(740);
      ...
      t.default = class Scroll {
        static scrollObserver(e) {
          ...
          return new IntersectionObserver(function handleIntersect(r) {
            ...
            e.callback({ sensitivity: e.sensitivity, isInViewport: i, scrollPercentage: s, intersectionScrollDirection: o }), (t = n);
          }, r);
        }
    ...
    5955: (e, t, r) => {
      ...
      var i = n(r(1192)),
        ...
        c = n(r(400)),
        l = n(r(869)),
        u = (window.elementorModules = { Module: i.default, ViewModule: o.default, ArgsObject: s.default, ForceMethodImplementation: l.default, utils: { Masonry: a.default, Scroll: c.default } });
      t.default = u;
    },
    5089: (e, t, r) => {
      var n = r(930),
      ...
      var n = r(3677),
        ...
        g = (e.exports = function (e, t, r) {
          "Symbol(" === String(t).slice(0, 7) && (t = "[" + String(t).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
            r && r.getter && (t = "get " + t),
            r && r.setter && (t = "set " + t),
            (!o(e, "name") || (a && e.name !== t)) && (s ? d(e, "name", { value: t, configurable: !0 }) : (e.name = t)),
            p && r && o(r, "arity") && e.length !== r.arity && d(e, "length", { value: r.arity });
          try {
            r && o(r, "constructor") && r.constructor ? s && d(e, "prototype", { writable: !1 }) : e.prototype && (e.prototype = void 0);
          } catch (e) {}
          var n = u(e);
        ...
        ? o
          ? function defineProperty(e, t, r) {
              if ((s(e), (t = a(t)), s(r), "function" == typeof e && "prototype" === t && "value" in r && p in r && !r.writable)) {
                var n = u(e, t);
                n && n.writable && ((e[t] = r.value), (r = { configurable: d in r ? r.configurable : n.configurable, enumerable: f in r ? r.enumerable : n.enumerable, writable: !1 }));
              }
              return l(e, t, r);
            }
          : l
    ...
    1557: (e, t, r) => {
      ...
      e.exports = function (e, t, r, v) {
        ...
        if (x) {
          ...
          if (((I.prototype = E), "Error" !== w ? (a ? a(I, T) : c(I, T, { name: !0 })) : g && y in x && (l(I, x, y), l(I, x, "prepareStackTrace")), c(I, x), !m))
            try {
    ...
    740: (e, t, r) => {
      var n = r(1695),
        ...
        exportGlobalErrorCauseWrapper = function (e, t) {
          var r = {};
          (r[e] = s(e, t, l)), n({ global: !0, constructor: !0, arity: 1, forced: l }, r);
        },
        exportWebAssemblyErrorCauseWrapper = function (e, t) {
          if (c && c[e]) {
            var r = {};
            (r[e] = s("WebAssembly." + e, t, l)), n({ target: a, stat: !0, constructor: !0, arity: 1, forced: l }, r);
          }
        };
