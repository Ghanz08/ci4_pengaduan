...
!(function (n) {
	...
	((u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) &&
		...
		u.define("select2/results", ["jquery", "./utils"], function (u, e) {
			function i(e, t, n) {
				(this.$element = e),
					(this.data = n),
					(this.options = t),
					...
					this.data.current(function (e) {
						...
						t.$results
							...
							.each(function () {
								...
								(null == t.element && -1 < u.inArray(n, i))
					...
					if (e.children) {
						for (
							var o = u(n),
								...
								r = ((s.className = "select2-results__group"), u(s)),
								a = (this.template(e, s), r.attr("role", "presentation"), []),
								l = 0;
							l < e.children.length;
							l++
						) {
						...
						r.append(a), o.attr("role", "list"), o.append(s), o.append(r);
						...
						this.$results.on(
							...
							function (e) {
								...
								o
									...
									o.trigger("results:focus", { data: t, element: u(this) });
							}
						);
				}),
					...
					(n.prototype.query = function (t, e) {
						...
						this.$element.children().each(function () {
							...
							(e.is("option") || e.is("optgroup")) &&
								((e = i.item(e)), null !== (e = i.matches(t, e))) &&
								n.push(e);
						}),
							e({ results: n });
					}),
