                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                <a href="javascript:;"><i class="fa-solid fa-user fa-lg" style="color: #000000;"></i></a>
                                <ul>
                                    <?php $session = session()?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                        <img src="/assets/img/slider-icon.png" class="rounded img-fluid d-block mx-auto" alt="First Vector Graphic">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="left-text col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix">
                    ...
                    <ul>
                        <li>
                            <img src="/assets/img/about-icon-01.png" alt="">
                            <div class="text">
                        ...
                        <li>
                            <img src="/assets/img/about-icon-02.png" alt="">
                            <div class="text">
                        ...
                        <li>
                            <img src="/assets/img/about-icon-03.png" alt="">
                            <div class="text">
            ...
            <div class="row">
                <div class="owl-carousel owl-theme">
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="/assets/img/service-icon-01.png" alt=""></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="/assets/img/service-icon-02.png" alt=""></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="/assets/img/service-icon-03.png" alt=""></i>
                        </div>
